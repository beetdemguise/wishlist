...
#
#     from wishlist import metadata
#
# However, when we do this, we also import `wishlist/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'wishlist_cli = wishlist.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'wishlist_gui = wishlist.gui:entry_point'
        # ]
    }
)
